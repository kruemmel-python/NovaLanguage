...
Die Beispiele sind bewusst progressiv aufgebaut:
            </p><p>Neu fuer den Unterricht: Zu jedem Modulbeispiel gehoert nun ein Abschnitt <code>Code verstehen: Was passiert in diesem Beispiel?</code>, der den Beispielcode zeilenweise, semantisch und aus Runtime-Sicht erklaert.
            <p>Die Beispiele sind bewusst progressiv aufgebaut:
